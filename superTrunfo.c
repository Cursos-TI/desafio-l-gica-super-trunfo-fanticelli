...
void compararAtributo(const struct Carta* carta1, const struct Carta* carta2, int tipoAtributo){
    ...
    switch (tipoAtributo){
        ...
        case 1: //recebendo ponteiro.
            ...
            resultadoComparacao = (carta1->populacao > carta2->populacao) ? "Carta 1 venceu!!" : 
            (carta2->populacao > carta1->populacao) ? "Carta 2 venceu!!" :
            "Empate";
        break;
        ...
        case 2: 
            ...
            resultadoComparacao = (carta1->area > carta2->area) ? "Carta 1 venceu!!" :
            (carta2->area > carta1->area) ? "Carta 2 venceu!!" :
            "Empate";
        break;
        ...
        case 3:
            ...
            resultadoComparacao = (carta1->PIB > carta2->PIB) ? "Carta 1 venceu!!" :
            (carta2->PIB > carta1->PIB) ? "Carta 2 venceu!!" :
            "Empate";
        break;
        ...
        case 4:
            ...
            resultadoComparacao = (carta1->pontosTuristicos > carta2->pontosTuristicos) ? "Carta 1 venceu!!" :
            (carta2->pontosTuristicos > carta1->pontosTuristicos) ? "Carta 2 venceu!!" :
            "Empate";
        break;
        ...
        case 5:
            ...
            resultadoComparacao = (carta1->resultados.densidadePopulacional < carta2->resultados.densidadePopulacional) ? "Carta 1 venceu!!" :
            (carta2->resultados.densidadePopulacional < carta1->resultados.densidadePopulacional) ? "Carta 2 venceu!!" :
            "Empate";
        break;
    ...
    do{
        ...
        switch (escolhaMenu){
            ...
            case 2:
                ...
                system("clear");
                double somaComparacao = carta1.escolhaComparacao1;
